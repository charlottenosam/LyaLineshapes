...
%DIF ADD ms_bubbles.tex          Tue Sep  8 19:38:10 2020
%
...
%DIF CMDIFF PREAMBLE %DIF PREAMBLE
...
\providecommand{\DIFdel}[1]{{\protect\color{Gray} \scriptsize \sout{#1}}} %DIF PREAMBLE
...
\newcommand{\DIFaddincludegraphics}[2][]{{\color{purple}\fbox{\DIFOincludegraphics[#1]{#2}}}} %DIF PREAMBLE
