...
%
\BE \label{eqn:tau_GP}
\tau_\textsc{gp}(z_s) = \frac{f_\alpha \pi e^2}{m_e \nu_\alpha} \frac{\xHI n_\textsc{h}(z_s)}{H(z_s)} \approx 4.7\times10^5 \xHI \left(\frac{n_\textsc{h}}{\nh}\right) \left(\frac{1+z_s}{8}\right)^{3/2}.
\EE
%
...
\Nion \approx 5.2\times10^{55} \left(\frac{1+z}{8}\right) \frac{10^{-0.4 (\MUV + 20)}}{\alpha(1+z)^{\beta + 2}}\left(\frac{912}{1500}\right)^{\beta + 2} \,\mathrm{s}^{-1}
\EE
%
